...
{		
		...
		**/
		...
		public function initMusic():void{
			var request:URLRequest = new URLRequest("resources/music/music1.mp3");
            music = new Sound();
            music.load(request);
		...
		*/
		...
		public function playOkSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/ok.mp3");
		...
		public function playExplosionSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/explosion.mp3");
            var sound:Sound = new Sound();
            sound.load(request);
			sound.play();
		}
		...
		public function playLoadBombSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/load.mp3");
            var sound:Sound = new Sound();
            sound.load(request);
			sound.play();
		}
		...
		public function playClickSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/clic.mp3");
            var sound:Sound = new Sound();
            sound.load(request);
			sound.play();
		}
		...
		public function playYeahSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/yeah.mp3");
            var sound:Sound = new Sound();
            sound.load(request);
			sound.play();
		}
		...
		public function playBipSound():void{
			...
			var request:URLRequest = new URLRequest("resources/music/sounds/bip.mp3");
            var sound:Sound = new Sound();
            sound.load(request);
			sound.play();
		}
		...
		//	var request:URLRequest = new URLRequest("resources/music/sounds/bonuses/"+bonusName+".mp3");
        //    var sound:Sound = new Sound();
        //     sound.load(request);
		//	sound.play();
		//}
