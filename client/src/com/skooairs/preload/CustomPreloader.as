...
{  
	...
	{  
		...
		[ Embed(source="com/skooairs/preload/greenBar.swf", mimeType="application/octet-stream") ]  
		...
		{  
			...
			bgSprite.graphics.beginFill(0x07230a);  
		...
		public function drawProgress(event: Event):void{  
			...
			if(currlen<progress){  
				...
				txtBox.text='Loading Skooairs...'+Math.round(currlen/2)+"%";  
